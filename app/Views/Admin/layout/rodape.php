...
<!-- Mirrored from htmlstream.com/front-dashboard/layouts/header-default-fluid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Oct 2020 11:03:55 GMT -->
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="<?php echo base_url('public/template');?>/favicon.ico">
  ...
  <link rel="stylesheet" href="<?php echo base_url('public/template');?>/assets/vendor/icon-set/style.css">
    ...
    <div class="js-mega-menu navbar-nav-wrap">
      <div class="navbar-brand-wrapper">
        <!-- Logo -->
          ...
          <a class="navbar-brand" href="<?php echo base_url('public/template');?>/index.html" aria-label="Front">
            <img class="navbar-brand-logo" src="<?php echo base_url('public/template');?>/assets/svg/logos/logo.svg" alt="Logo">
          </a>
                            ...
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img3.jpg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <div class="col ml-n3">
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img10.jpg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <div class="col ml-n3">
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/svg/brands/google.svg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <div class="col ml-n3">
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img7.jpg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <div class="col ml-n3">
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img5.jpg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <div class="col ml-n3">
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img8.jpg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <div class="col ml-n3">
                  ...
                  <div class="nav nav-pills flex-column">
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="<?php echo base_url('public/template');?>/assets/svg/brands/atlassian.svg" alt="Image Description">
                        </span>
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="<?php echo base_url('public/template');?>/assets/svg/brands/slack.svg" alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="<?php echo base_url('public/template');?>/assets/svg/brands/google-webdev.svg" alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="<?php echo base_url('public/template');?>/assets/svg/brands/frontapp.svg" alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="<?php echo base_url('public/template');?>/assets/svg/illustrations/review-rating-shield.svg" alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
          ...
          <li class="nav-item">
            ...
            <div class="hs-unfold">
              <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
                ...
                <div class="avatar avatar-sm avatar-circle">
                  <img class="avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img6.jpg" alt="Image Description">
          ...
          <ul class="navbar-nav flex-grow-1">
            ...
            <li class="hs-has-sub-menu">
              ...
              <ul id="navLinkDashboardsDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="dashboardsDropdown" style="min-width: 16rem;">
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/index.html">
                    <span class="tio-circle nav-indicator-icon"></span> Default
                  </a>
                </li>
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/dashboard-alternative.html">
              ...
              <ul id="navLinkPagesDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdown" style="min-width: 16rem;">
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownUsers" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownUsers" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/users.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Overview
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/users-leaderboard.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Leaderboard
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/users-add-user.html">
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownUserProfile" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownUserProfile" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/user-profile.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Profile
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/user-profile-teams.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Teams
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/user-profile-projects.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Projects
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/user-profile-connections.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Connections
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/user-profile-my-profile.html">
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownAccount" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownAccount" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/account-settings.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Settings
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/account-billing.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Billing
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/account-invoice.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Invoice
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/account-api-keys.html">
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownProjects" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownProjects" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/projects.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Overview
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/projects-timeline.html">
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownProject" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownProject" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/project.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Overview
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/project-files.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Files <span class="badge badge-info badge-pill ml-1">Hot</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/project-activity.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Activity
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/project-teams.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Teams
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/project-settings.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Settings
                      </a>
                    </li>
                  </ul>
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownSignin" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownSignin" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-signin-basic.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Basic
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-signin-cover.html">
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownSignup" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownSignup" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-signup-basic.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Basic
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-signup-cover.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Cover
                      </a>
                    </li>
                  </ul>
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownResetPassword" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownResetPassword" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-reset-password-basic.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Basic
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-reset-password-cover.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Cover
                      </a>
                    </li>
                  </ul>
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownEmailVerification" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdownEmailVerification" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-email-verification-basic.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Basic
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-email-verification-cover.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Cover
                      </a>
                    </li>
                  </ul>
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdown2StepVerification" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdown2StepVerification" style="min-width: 16rem;">
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-two-step-verification-basic.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Basic
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url('public/template');?>/authentication-two-step-verification-cover.html">
                        <span class="tio-circle-outlined nav-indicator-icon"></span> Cover
                      </a>
                    </li>
                  </ul>
                ...
                <!-- Welcome Page -->
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/error-404.html">
                ...
                <!-- Welcome Page -->
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/error-500.html">
                ...
                <!-- Welcome Page -->
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/welcome-page.html">
            ...
            <li class="hs-has-sub-menu">
              ...
              <ul id="navLinkappsNavDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="appsNavDropdown" style="min-width: 16rem;">
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/apps-kanban.html">
                    <span class="tio-circle nav-indicator-icon"></span> Kanban
                  </a>
                </li>
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/apps-invoice-generator.html">
                    <span class="tio-circle nav-indicator-icon"></span> Invoice generator
                  </a>
                </li>
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/apps-file-manager.html">
            ...
            <!-- Layouts -->
            <li>
              <a class="navbar-nav-link nav-link" href="layouts.html">
            ...
            <li class="hs-has-sub-menu">
              ...
              <ul id="navLinkDocumentationDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="documentationDropdown" style="min-width: 16rem;">
                <li>
                  <a class="dropdown-item" href="<?php echo base_url('public/template');?>/documentation/index.html">
      ...
      <div class="row justify-content-lg-center pt-lg-5 pt-xl-10">
        <div class="col-lg-9">
          ...
          <div class="text-center">
            <img class="img-fluid shadow-soft mb-5" src="<?php echo base_url('public/template');?>/assets/svg/layouts/header-default-fluid.svg" alt="Image Description" style="max-width: 15rem;">

            <h1>Main Header (Fluid)</h1>
      ...
      <div class="card-body sidebar-body">
        ...
        <ul class="step step-icon-sm step-avatar-sm">
          ...
          <li class="step-item">
            <div class="step-content-wrapper">
              <div class="step-avatar">
                <img class="step-avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img9.jpg" alt="Image Description">
              </div>
                  ...
                  <li class="list-group-item list-group-item-light">
                    <div class="row gx-1">
                      <div class="col-6">
                        <div class="media">
                            <span class="mt-1 mr-2">
                              <img class="avatar avatar-xs" src="<?php echo base_url('public/template');?>/assets/svg/brands/excel.svg" alt="Image Description">
                            </span>
                          <div class="media-body text-truncate">
                      ...
                      <div class="col-6">
                        <div class="media">
                            <span class="mt-1 mr-2">
                              <img class="avatar avatar-xs" src="<?php echo base_url('public/template');?>/assets/svg/brands/word.svg" alt="Image Description">
                            </span>
                          <div class="media-body text-truncate">
                            <span class="d-block font-size-sm text-dark text-truncate" title="weekly-reports.xls">weekly-reports.xls</span>
          ...
          <li class="step-item">
            <div class="step-content-wrapper">
              <div class="step-avatar">
                <img class="step-avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img3.jpg" alt="Image Description">
              </div>
              ...
              <div class="step-content">
                ...
                <ul class="list-group list-group-sm">
                  <li class="list-group-item list-group-item-light">
                    <div class="row gx-1">
                      <div class="col">
                        <img class="img-fluid rounded ie-sidebar-activity-img" src="<?php echo base_url('public/template');?>/assets/svg/illustrations/card-1.svg" alt="Image Description">
                      </div>
                      <div class="col">
                        <img class="img-fluid rounded ie-sidebar-activity-img" src="<?php echo base_url('public/template');?>/assets/svg/illustrations/card-2.svg" alt="Image Description">
                      </div>
                      <div class="col">
                        <img class="img-fluid rounded ie-sidebar-activity-img" src="<?php echo base_url('public/template');?>/assets/svg/illustrations/card-3.svg" alt="Image Description">
                      </div>
          ...
          <li class="step-item">
            <div class="step-content-wrapper">
              <div class="step-avatar">
                <img class="step-avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img7.jpg" alt="Image Description">
              </div>
          ...
          <li class="step-item">
            <div class="step-content-wrapper">
              <div class="step-avatar">
                <img class="step-avatar-img" src="<?php echo base_url('public/template');?>/assets/img/160x160/img5.jpg" alt="Image Description">
              </div>
